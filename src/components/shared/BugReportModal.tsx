        ...
        <div className="px-5 pt-5 pb-6">
          {status === 'sent' ? (
            <div className="text-center py-4">
              <p className="text-label font-cinzel uppercase tracking-widest mb-2 text-gold">
                Report Received
              </p>
              ...
              <button
                onClick={onClose}
                className="mt-4 px-4 py-2 text-label font-cinzel uppercase tracking-widest rounded-sm"
            ...
            <>
              ...
              <p className="text-label font-body italic mb-4 text-gold-faint">
              ...
              <textarea
                ...
                rows={3}
                className="w-full text-label font-body rounded-sm px-3 py-2 resize-none mb-3"
                style={{
              ...
              {errorContext && (
                ...
                >
                  <p className="text-micro font-cinzel uppercase tracking-widest mb-1 text-gold-dim">
                    Error attached automatically
                  </p>
                  <p className="text-micro font-body truncate" style={{ color: '#3a3020' }}>
                    {errorContext}
                  </p>
                </div>
              )}
              ...
              {status === 'error' && (
                <p className="text-label font-body italic mb-3" style={{ color: '#c06060' }}>
              ...
              <div className="flex gap-2">
                <button
                  onClick={onClose}
                  className="flex-1 py-2 text-label font-cinzel uppercase tracking-widest rounded-sm"
                ...
                <button
                  ...
                  className="flex-1 py-2 text-label font-cinzel uppercase tracking-widest rounded-sm transition-opacity hover:opacity-90 disabled:opacity-50"
                  style={{
