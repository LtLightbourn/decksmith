/**
 * Email sent when a user's Pro subscription activates.
 * Returns { subject, html }
 */
export function welcomeProEmail({ firstName, appUrl }) {
  return {
    subject: 'Welcome to Decksmith Pro ✦ Unlimited builds unlocked',
    html: `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  ...
  <title>Welcome to Decksmith Pro</title>
</head>
          ...
          <tr>
            <td style="padding:38px 36px 32px;">
              ...
              <h1 style="margin:0 0 18px;font-family:Georgia,'Times New Roman',serif;
                ...
                The Guild Welcomes You,<br>${firstName}
              </h1>
              ...
              <p style="margin:0 0 14px;font-size:15px;color:#7a6a4a;line-height:1.75;">
                Your Pro subscription is now active. Merlin is at your command
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
                ...
                ${[
                  'Unlimited AI deck builds &mdash; build as many as you want',
                  'Chat with Merlin to refine any deck in your collection',
                  'Advanced upgrade suggestions tailored to your pod',
